package com.example.test_location.BloomFilter;
...
public class BloomFilter<E> implements Serializable {
    ...
    public BloomFilter(BitSet bitset, int bitSetSize, int expectedNumberOfFilterElements, int numberOfAddedElements, int k){
        this.bitset = bitset;
        this.bitSetSize = bitSetSize;
        this.expectedNumberOfFilterElements = expectedNumberOfFilterElements; // expected (maximum) number of elements to be added
        this.numberOfAddedElements = numberOfAddedElements; // number of elements actually added to the Bloom filter
        this.k = k; // number of hash functions
    }

    public void printInfo(){
        System.out.println(bitSetSize+"|"+expectedNumberOfFilterElements+"|"+numberOfAddedElements+"|"+k);
    }
